...
if (isset($_POST["logout"]) && $_POST["logout"] == '1') {
...
} elseif (isset($_POST["name"]) && $_POST["name"] != '' && $existingUser = $userManager->getOneUserByName($_POST["name"])) {
    ...
    if (isset($_POST["email"]) && $_POST["email"] != '' && $existingUser = $userManager->getOneUserByEmail($_POST["email"])) {
