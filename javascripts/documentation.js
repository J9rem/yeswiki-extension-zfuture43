...
window.$docsify = {
    ...
    auto2top: true,
    alias: {
      ['.*/_sidebar.md']: `/tools/zfuture43/docs/users/${locale}/_sidebar.md`, // set default _sidebar.md to locale language
      ['.*/_navbar.md']: `/tools/zfuture43/docs/users/${locale}/_navbar.md`, // set default _sidebar.md to locale language
    },
    search: {
      placeholder: {
        '/tools/zfuture43/docs/users/fr/': 'Rechercher...',
        '/': 'Search...' // default to English
      },
      noData: {
        '/tools/zfuture43/docs/users/fr/': 'Pas de résultats',
    ...
    copyCode: {
      buttonText : {
        '/tools/zfuture43/docs/users/fr/': 'Copier le code',
        '/': 'Copy to clipboard' // default to English
      },
      errorText : 'Error',
      successText : {
        '/tools/zfuture43/docs/users/fr/': 'Copié',
    ...
    plugins: [
      function(hook, vm) {
        hook.afterEach(function(html) {
          ...
          // Adds footer
          if (vm.route.file.match(/^tools\/zfuture43\/docs\/.*$/)){
            const url = `https://github.com/J9rem/yeswiki-extension-zfuture43/edit/master/${vm.route.file.replace(/tools\/zfuture43\//,'')}`
            const footer = `
              <hr/>
              <footer>
        ...
        hook.ready(function() {
          ...
          if (location.hash == "#/") location.hash = `/tools/zfuture43/docs/users/${locale}/README`
