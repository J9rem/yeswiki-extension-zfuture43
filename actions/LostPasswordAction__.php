...
class LostPasswordAction__ extends YesWikiAction
{
    ...
    public function run()
    {
        ...
        if (isset($_POST['subStep']) && !isset($_GET['a'])) {
            ...
            if (empty($hash)) {
                ...
                $user = $this->userManager->getOneUserByName(base64_decode($encodedUser));
                if (empty($user)) {
        ...
        switch ($subStep) {
            case 1:
                ...
                if (empty($email)) {
                    ...
                    $user = $this->userManager->getOneUserByEmail($email);
                    if (!empty($user)) {
            ...
            case 2:
                ...
                $user = $this->userManager->getOneUserByName($userName);
                $this->typeOfRendering = 'recoverForm';
